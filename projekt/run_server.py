...
if __name__ == "__main__":
    ...
    coordinator_program = ["python", "coordinator.py",
                           "--coordinator_host", coordinator_host,
                           "--coordinator_port", str(coordinator_port)]
    server_programs = []
    for i, port in enumerate(server_ports):
        server_programs.append(["python", "hls-server/server.py",
                                "--coordinator_host", coordinator_host,
                                "--coordinator_port", str(coordinator_port),
    ...
    programs = [coordinator_program]
    programs.extend(server_programs)
